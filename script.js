...
//     const postDisplay = document.getElementById("postDisplay"); // Define postDisplay here
...
//     postDiv.querySelector('.deleteButton').addEventListener('click', async () => {
//         Swal.fire({
//                         icon: 'warning',
//                         title: 'Delete Post',
...
//     postDiv.querySelector('.editButton').addEventListener('click', async () => {
//         Swal.fire({
//                         title: 'Edit Post',
//                         html:
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    onAuthStateChanged(auth, async (user) => {
        if (user) {
            console.log("Adding event listener for submitButton")
            submitButton.addEventListener("click", async () => {
                const heading = document.getElementById("headingPost").value;
                const description = document.getElementById("titlePost").value;
